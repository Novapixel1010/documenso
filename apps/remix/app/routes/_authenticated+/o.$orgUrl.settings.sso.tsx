    ...
    <div className="max-w-2xl">
      ...
      >
        <div className="mb-4 sm:mb-0">
          <AlertTitle>
            <Trans>Test configuration</Trans>
          </AlertTitle>

          <AlertDescription className="mr-2">
            <Trans>
              Test SSO configuration to ensure it is working correctly. Please note that this is
              testing the details stored in our database, not the form above.
            </Trans>
          </AlertDescription>
        </div>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <fieldset disabled={form.formState.isSubmitting} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-xs">
              <Trans>Add this URL to your OIDC provider's allowed redirect URIs</Trans>
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-xs">
              <Trans>This is the required scopes you must allow for your OIDC provider</Trans>
            </p>
          </div>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                {!form.formState.errors.wellKnownUrl && (
                  <p className="text-muted-foreground text-xs">
                    <Trans>The discovery endpoint URL for your OIDC provider</Trans>
                  </p>
                )}
                <FormMessage />
              </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input id="client-id" placeholder={`your-client-id`} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
